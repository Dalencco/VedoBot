...
client.on("guildMemberAdd", async (user) => {
    ...
    const canvas = createCanvas(400, 200)
        ...
        client.channels.cache.get("975504916451852318").send({ files: [ri], content: `Bienvenid@ ${user.user.toString()} Al server de ${user.guild.name}! Tu eres el miembro #${user.guild.memberCount}, Asegurate de leerte las reglas y demas para evitar posibles sanciones dentro del Server` })
})